...
namespace FoxitRDK
{
    // @interface SWIGTYPE_foxit__pdf__objects__PDFNumberTree : NSObject
    [BaseType(typeof(NSObject))]
    [DisableDefaultCtor]
    interface SWIGTYPE_foxit__pdf__objects__PDFNumberTree
    {
        // -(void *)getCptr;
        //[Export("getCptr")]
        
        //unsafe IntPtr Cptr { get; }

        // -(id)initWithCptr:(void *)cptr swigOwnCObject:(BOOL)ownCObject;
        //[Export("initWithCptr:swigOwnCObject:")]
        //unsafe IntPtr Constructor(IntPtr cptr, bool ownCObject);
    }
    ...
    interface FSRenderer
    {
        ...
        unsafe IntPtr Constructor(IntPtr context, FSRendererDeviceType device_type);
    ...
    interface FSXFADoc
    {
        ...
        // -(void)exportData:(NSString *)output_file_path export_type:(FSXFADocExportDataType)export_type;
        [Export("exportData:export_type:")]
        void ExportData(string output_file_path, FSXFADocExportDataType export_type);
    ...
    interface FSAssociatedFiles
    {
        ...
        // -(int)getAssociatedFilesCount:(FSPDFObject *)object;
        [Export("getAssociatedFilesCount:")]
        int GetAssociatedFilesCount(FSPDFObject @object);

        // -(FSFileSpec *)getAssociatedFile:(FSPDFObject *)object index:(int)index;
        [Export("getAssociatedFile:index:")]
        FSFileSpec GetAssociatedFile(FSPDFObject @object, int index);

        // -(void)associateFile:(FSPDFObject *)object file_spec:(FSFileSpec *)file_spec;
        [Export("associateFile:file_spec:")]
        void AssociateFile(FSPDFObject @object, FSFileSpec file_spec);

        // -(void)removeAssociatedFile:(FSPDFObject *)object index:(int)index;
        [Export("removeAssociatedFile:index:")]
        void RemoveAssociatedFile(FSPDFObject @object, int index);
    ...
    interface FSPDFDoc
    {
        ...
        // -(FSProgressive *)startSaveAsPayloadFile:(NSString *)file_path payload_file_path:(NSString *)payload_file_path sub_type:(NSString *)sub_type description:(NSString *)description version:(float)version save_flags:(unsigned int)save_flags pause:(id<FSPauseCallback>)pause;
        [Export("startSaveAsPayloadFile:payload_file_path:sub_type:description:version:save_flags:pause:")]
        FSProgressive StartSaveAsPayloadFile(string file_path, string payload_file_path, string sub_type, string description, float version, uint save_flags, FSPauseCallback pause);
        ...
        // -(unsigned int)addIndirectObject:(FSPDFObject *)object;
        [Export("addIndirectObject:")]
        uint AddIndirectObject(FSPDFObject @object);
    ...
    interface FSFileSpec
    {
        ...
        // -(id)initWithDocument:(FSPDFDoc *)document object:(FSPDFObject *)object;
        [Export("initWithDocument:object:")]
        IntPtr Constructor(FSPDFDoc document, FSPDFObject @object);
    ...
    interface FSPageLabels
    {
        ...
        // -(SWIGTYPE_foxit__pdf__objects__PDFNumberTree *)getNumberTree;
        [Export("getNumberTree")]
        
        SWIGTYPE_foxit__pdf__objects__PDFNumberTree NumberTree { get; }
    ...
    {
        // @property (getter = getPosition, nonatomic) FSWatermarkSettingsPosition position;
        [Export("position", ArgumentSemantic.Assign)]
        FSWatermarkSettingsPosition Position { [Bind("getPosition")] get; set; }
        ...
        // -(void)set:(FSWatermarkSettingsPosition)position offset_x:(float)offset_x offset_y:(float)offset_y flags:(unsigned int)flags scale_x:(float)scale_x scale_y:(float)scale_y rotation:(float)rotation opacity:(int)opacity;
        [Export("set:offset_x:offset_y:flags:scale_x:scale_y:rotation:opacity:")]
        void Set(FSWatermarkSettingsPosition position, float offset_x, float offset_y, uint flags, float scale_x, float scale_y, float rotation, int opacity);
    ...
    interface FSPDFNameTree
    {
        ...
        // -(BOOL)setObj:(NSString *)name object:(FSPDFObject *)object;
        [Export("setObj:object:")]
        bool SetObj(string name, FSPDFObject @object);
        ...
        // -(BOOL)add:(NSString *)name object:(FSPDFObject *)object;
        [Export("add:object:")]
        bool Add(string name, FSPDFObject @object);
    ...
    interface FSFileReaderCallback
    {
        ...
        [Abstract]
        [Export("getSize")]
        ulong FSFileReaderCallbackSize { get; }
    }
    ...
    {
        // @required -(NSData *)writeBlock:(unsigned long long)offset size:(unsigned long long)size;
        [Abstract]
        [Export("writeBlock:size:")]
        NSData Size(ulong offset, ulong size);

        // @required -(unsigned long long)getSize;
        [Abstract]
        [Export("getSize")]
        ulong FSFileWriterCallbackSize { get; }
    ...
    {
        // @required -(NSString *)getAppInfo:(FSActionCallbackAppInfoType)app_info;
        [Abstract]
        [Export("getAppInfo:")]
        string GetAppInfo(FSActionCallbackAppInfoType app_info);
    ...
    interface FSDocProviderCallback
    {
        ...
        // @required -(BOOL)getPopupPos:(int)page_index min_popup:(float)min_popup max_popup:(float)max_popup rect_widget:(FSRectF *)rect_widget inout_rect_popup:(FSRectF *)inout_rect_popup;
        [Abstract]
        [Export("getPopupPos:min_popup:max_popup:rect_widget:inout_rect_popup:")]
        bool GetPopupPos(int page_index, float min_popup, float max_popup, FSRectF rect_widget, FSRectF inout_rect_popup);
        ...
        // @required -(int)getCurrentPage:(FSPDFDoc *)doc;
        [Abstract]
        [Export("getCurrentPage:")]
        int GetCurrentPage(FSPDFDoc doc);

        // @required -(void)setCurrentPage:(FSPDFDoc *)doc current_page_index:(int)current_page_index;
        [Abstract]
        [Export("setCurrentPage:current_page_index:")]
        void SetCurrentPage(FSPDFDoc doc, int current_page_index);

        // @required -(NSString *)getTitle:(FSPDFDoc *)doc;
        [Abstract]
        [Export("getTitle:")]
        string GetTitle(FSPDFDoc doc);

        // @required -(void)setFocus:(FSWidget *)xfa_widget;
        [Abstract]
        [Export("setFocus:")]
        void SetFocus(FSWidget xfa_widget);

        // @required -(void)exportData:(FSPDFDoc *)doc file_path:(NSString *)file_path;
        [Abstract]
        [Export("exportData:file_path:")]
        void ExportData(FSPDFDoc doc, string file_path);

        // @required -(void)importData:(FSPDFDoc *)doc file_path:(NSString *)file_path;
        [Abstract]
        [Export("importData:file_path:")]
        void ImportData(FSPDFDoc doc, string file_path);

        // @required -(void)gotoURL:(FSPDFDoc *)doc url:(NSString *)url;
        [Abstract]
        [Export("gotoURL:url:")]
        void GotoURL(FSPDFDoc doc, string url);

        // @required -(void)print:(FSPDFDoc *)doc start_page_index:(int)start_page_index end_page_index:(int)end_page_index options:(int)options;
        [Abstract]
        [Export("print:start_page_index:end_page_index:options:")]
        void Print(FSPDFDoc doc, int start_page_index, int end_page_index, int options);

        // @required -(int)getHighlightColor:(FSPDFDoc *)doc;
        [Abstract]
        [Export("getHighlightColor:")]
        int GetHighlightColor(FSPDFDoc doc);

        // @required -(BOOL)submitData:(FSPDFDoc *)doc target:(NSString *)target format:(FSDocProviderCallbackSubmitFormat)format text_encoding:(FSDocProviderCallbackTextEncoding)text_encoding content:(NSString *)content;
        [Abstract]
        [Export("submitData:target:format:text_encoding:content:")]
        bool SubmitData(FSPDFDoc doc, string target, FSDocProviderCallbackSubmitFormat format, FSDocProviderCallbackTextEncoding text_encoding, string content);
    }
